---
title: "Analyzing the 2021 Winter Storm in Houston, Texas"
...
NL_0207_v05 <- stars::read_stars(here("data/VNP46A1/VNP46A1.A2021038.h08v05.001.2021039064328.tif"))
# h08v06 on 2021-02-07
NL_0207_v06 <- stars::read_stars(here("data/VNP46A1/VNP46A1.A2021038.h08v06.001.2021039064329.tif"))
# h08v05 on 2021-02-16
NL_0216_v05 <- stars::read_stars(here("data/VNP46A1/VNP46A1.A2021047.h08v05.001.2021048091106.tif"))
# h08v06 on 2021-02-16
NL_0216_v06 <- stars::read_stars(here("data/VNP46A1/VNP46A1.A2021047.h08v06.001.2021048091105.tif"))
```
...
homes <- st_read(here("data/gis_osm_buildings_a_free_1.gpkg/gis_osm_buildings_a_free_1.gpkg"), 
                 query = homes_query)
...
houston_counties <- st_read(here("data/houston_county_boundaries/houston-county-boundaries.shp")) %>% 
...
st_layers(here("data/ACS_2019_5YR_TRACT_48_TEXAS.gdb/ACS_2019_5YR_TRACT_48_TEXAS.gdb"))

# load in the geometries layer & assign the same CRS as the blackout mask
acs_geometry <- st_read(here("data/ACS_2019_5YR_TRACT_48_TEXAS.gdb/ACS_2019_5YR_TRACT_48_TEXAS.gdb"), 
                        layer = "ACS_2019_5YR_TRACT_48_TEXAS") %>% 
  st_transform(crs(blackout_mask_houston_no_highways))

# load in the income layer
acs_income <- st_read(here("data/ACS_2019_5YR_TRACT_48_TEXAS.gdb/ACS_2019_5YR_TRACT_48_TEXAS.gdb"), 
                      layer = "X19_INCOME")
